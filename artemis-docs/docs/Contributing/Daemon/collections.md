...
The TOML file should have the same format as [standard collection TOML file](../../Intro/Collections/format.md) and should have the following fields:
...
- destination: Output type. This can be LOCAL, GCP, AZURE, AWS, or API. 
...
- filter_script: An advanced **optional** field. Artemis will pass
    ...
    [scripting](../../Intro//Scripting/boa.md) section for detailed overview of this
    option.
...
The JSONL output format is the same [format](../../Intro//Collections/output.md) when running artemis as a CLI tool