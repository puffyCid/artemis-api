...
Let walkthrough a scenario on we can leverage the API to extract data from the Windows [User Access Logging database](https://www.crowdstrike.com/blog/user-access-logging-ual-overview/) (UAL).
The guide below assumes you have cloned the artemis API repository to your local system. You may also import the API remotely.
